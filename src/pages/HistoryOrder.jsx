...
// const HistoryOrder = ({ bookings }) => {
//     const { bookingHistory, loading, error } = useBookingHistory(bookings);
...
const HistoryOrder = ({ userId, bookingCode, date }) => {
  const { bookings, fetchBookings, loading, error } = useFetchBookings();

  useEffect(() => {
    const queryParams = { userId, bookingCode, date };
    fetchBookings(queryParams);
  }, [fetchBookings, userId, bookingCode, date]);
