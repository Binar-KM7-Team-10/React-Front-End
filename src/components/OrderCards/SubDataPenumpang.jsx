        ...
        <div className='rounded-lg mb-10'>
            ...
            <div className="body-card px-5">
                <div className='flex flex-col my-6'>
                    <label htmlFor="" className='font-semibold text-purple-800 mb-2 text-sm'>Tittle</label>
                ...
                <div className='flex flex-col my-6'>
                    ...
                    <input type="date" className='border-2 py-3 px-4 text-sm rounded-[4px] w-full' />
                </div>
                <div className='flex flex-col my-6'>
